          ...
          <tr>
            <th className="summary-table-header" onClick={() => onSort("name")}>
              <div className="summary-table-header-content">
                Name
                <span className="summary-table-sort-icon">
                  {getSortIcon("name")}
                </span>
              </div>
            </th>
            ...
            <th
              className="summary-table-header"
              onClick={() => onSort("transitions")}
            >
              <div className="summary-table-header-content">
                Transitions
                <span className="summary-table-sort-icon">
                  {getSortIcon("transitions")}
                </span>
              </div>
            </th>
          </tr>
          ...
          {automata.length === 0 ? (
            ...
            automata.map((automaton, index) => (
              <tr key={index} className="summary-table-row">
                <td className="summary-table-cell summary-table-cell-name">
                  {automaton.name}
                </td>
